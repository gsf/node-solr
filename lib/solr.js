...
Client.prototype.query = function(query, options, callback) {
  ...
  queryParams.q = query;
  queryParams.wt = "json";
  this.get("select", queryParams, callback);
};
...
Client.prototype.get = function(queryPath, queryParams, callback) {
  if (callback === undefined) {
    callback = queryParams;
    delete queryParams;
  }
  if (queryParams) {
    queryPath += "?" + querystring.stringify(queryParams);
  }

  var options = {
    method: "GET",
    path: this.path + this.core + "/" + queryPath,
    headers: {
      "Host": this.fullHost
    }
  };
...
exports.createClient = function(host, port, core, path) {
  ...
  client.sendRequest = function(options, callback) {
    ...
    var buffer = '';
    //console.warn("solr: sendRequest " + util.inspect(requestOptions));
    ...
    if (options.data) {
      //console.warn("solr: write '" + options.data + "'");
